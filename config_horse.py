...
result_dir = '/home/newmoon/GAN/CapsGAN/Generator_Results/LSUN_horse'#/home/newmoon/GAN/CapsGAN/Generator_Results/LSUN_res'
...
#64,32,16,8,8,4
desc        = 'G_paper_caps64_64_64_64_32_32_32_D_paper_it20_minibatch_repeat_4'#_justtest'#continu1_G_paper_caps_64_64_64_64_32_32_32_0__D_paper_minibatch_rep4_latent512_withIter20sqrt_fue_false'#_dataset100k'# _caps32_16_8_4_2_2_D_paper_capsconv_capsdense32_16_8_4_2_2_latent128_D_repeats1'                                        # Description string included in result subdir name.
...
train       = EasyDict(func='train.train_progressive_gan',minibatch_repeats=4)#,resume_run_id=1,resume_kimg=20000)#,D_repeats=4)  # Options for main training func.
...
desc += '-nogrowing'; sched.lod_initial_resolution = 256; sched.lod_training_kimg = 0; sched.lod_transition_kimg = 0; train.total_kimg = 20000
