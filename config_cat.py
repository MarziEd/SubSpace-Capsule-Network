...
result_dir = '/home/newmoon/GAN/CapsGAN/Generator_Results/LSUN_cat'#/home/newmoon/GAN/CapsGAN/Generator_Results/LSUN_res'
...
#64,32,16,8,8,4
desc        = 'pgan_G_caps_half_bi64_64_64_64_32_32_32_D_paper_it20_minibatch_repeat_1'#_justtest'#continu1_G_paper_caps_64_64_64_64_32_32_32_0__D_paper_minibatch_rep4_latent512_withIter20sqrt_fue_false'#_dataset100k'# _caps32_16_8_4_2_2_D_paper_capsconv_capsdense32_16_8_4_2_2_latent128_D_repeats1'                                        # Description string included in result subdir name.
...
train       = EasyDict(func='train.train_progressive_gan',minibatch_repeats=1)#,resume_run_id=1,resume_kimg=20000)#,D_repeats=4)  # Options for main training func.
G           = EasyDict(func='networks.G_paper_caps_half_bi',fused_scale=False)#,structure='recursive')#,fmap_base=2048,fmap_max=512,latent_size=512)#,resolution=128) #   networks.G_paper_caps networks.G_paper_caps    ,structure='recursive')             # Options for generator network.
