...
class TFRecordDataset:
    def __init__(self,
        ...
        shuffle_mb      = 4096,#4096,     # Shuffle data within specified window (megabytes), 0 = disable shuffling.
        prefetch_mb     = 2048,#4096,#3072,#2048,     # Amount of data to prefetch (megabytes), 0 = disable prefetching.
        buffer_mb       = 256,#2048,#1024,      # Read buffer size (megabytes).
        ...
        with tf.name_scope('Dataset'), tf.device('/cpu:0'):
            ...
            print('********************* self._tf_datasets[0].output_shapes',self._tf_datasets[0].output_shapes)
            #print('********************* self._tf_datasets.output_shapes',self._tf_datasets.output_shapes)
